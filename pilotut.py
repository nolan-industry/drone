...
def absolute_heading(heading, relative=False):
    """
...
def relative_heading(heading, relative=True):
    """
    Send MAV_CMD_CONDITION_YAW message to point vehicle at a specified heading (in degrees).

    This method sets an relative heading
...
def relative_ned_velocity(velocity_x, velocity_y, velocity_z, duration):
    """
...
def absolute_global_velocity(velocity_x, velocity_y, velocity_z, duration):
    """
